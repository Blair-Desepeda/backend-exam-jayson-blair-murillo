...
<hr>
<label id="title" style="margin:-1% 0 0 0;float:center;font-size:2.3rem;">Backend Exam</label>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td id="edit-column">
        ...
        <a href="{{url('/user/'.$display_data->id.'/destroy/')}}" class="btn btn-danger" id="delete-btn">DELETE</a>
      </td>
    </tr>
    @endforeach
