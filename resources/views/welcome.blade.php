            ...
            <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                <header class="grid grid-cols-2 items-center gap-2 py-10 lg:grid-cols-3" style="background-color: transparent;">
                    <div class="flex lg:justify-center lg:col-start-2">
                        ...
                        <label id="title" style="margin: 5% 0 0 0;float:left;font-size:2.3rem;">Backend Exam</label>
                    ...
                    <nav class="-mx-3 flex flex-1 justify-end">
                        ...
                        <a
                            href="{{ route('login') }}"
                            class="rounded-md px-3 py-2 text-black ring-1 ring-transparent transition hover:text-black/70 focus:outline-none focus-visible:ring-[#FF2D20] dark:text-white dark:hover:text-white/80 dark:focus-visible:ring-white"
                            style="font-size: 1.2rem; border:1px solid orange;margin:5% 1% 0 0">
                            Log in
                        </a>
                        ...
                        <a
                            href="{{ route('register') }}"
                            class="rounded-md px-3 py-2 text-black ring-1 ring-transparent transition hover:text-black/70 focus:outline-none focus-visible:ring-[#FF2D20] dark:text-white dark:hover:text-white/80 dark:focus-visible:ring-white"
                            style="font-size: 1.2rem; border:1px solid black;margin:5% 1% 0 0">
                            Register
                        </a>
                        @endif
                        @endauth
